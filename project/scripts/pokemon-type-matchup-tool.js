    ...
    icon.addEventListener("click", function () {
        ...
        if (newIconsSelected.length > 0) {
            ...
            if (newPokemonArray.length > 0) {
                ...
                pokemonPic.src = "https://wiki.p-insurgence.com/images/0/09/722.png";
                pokemonPic.alt = "MissingNo.";
            }
        }
        else {
...
const pokemon = [
    ...
    { name: "Zorua-Hisuian", type: "Normal/Ghost"},
    { name: "Zoroark", type: "Dark" },
    { name: "Zoroark-Hisuian", type: "Normal/Ghost"},
