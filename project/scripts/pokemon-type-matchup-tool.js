...
iconArray.forEach(icon => {
    icon.addEventListener("click", function() {
        const numIconsSelected = document.getElementsByClassName("selected").length;
        ...
        const newIconsSelected = document.getElementsByClassName("selected");

        let type1;
        let type2;
        if (newIconsSelected.length > 0)
        {
            type1 = newIconsSelected[0].alt;

            if (newIconsSelected.length == 2)
            {
                type2 = newIconsSelected[1].alt;
            }
            else
            {
                type2 = "";
            ...
            {
                pokemonCaption.textContent = "None exist yet!"
            }
        }
        else
        {
...
{
    return pokemonArr.filter(mon => (mon.type.includes(type1) && mon.type.includes(type2)));
}       
...
const pokemon = [
  ...
  { name: "Alakazam (Mega)", type: "Psychic" },
  ...
  { name: "Slowbro (Mega)", type: "Water/Psychic" },
  ...
  { name: "Farfetch’d (Galarian)", type: "Fighting" },
  ...
  { name: "Gengar (Mega)", type: "Ghost/Poison" },
  { name: "Onix", type: "Rock/Ground" },
  { name: "Steelix", type: "Steel/Ground" },
  { name: "Steelix (Mega)", type: "Steel/Ground" },
  ...
  { name: "Kangaskhan (Mega)", type: "Normal" },
  ...
  { name: "Scizor (Mega)", type: "Bug/Steel" },
  ...
  { name: "Tauros (Paldean Combat Breed)", type: "Fighting" },
  ...
  { name: "Aerodactyl (Mega)", type: "Rock/Flying" },
  { name: "Snorlax", type: "Normal" },
  { name: "Snorlax (Gigantamax)", type: "Normal" },
  ...
  { name: "Mewtwo (Mega Y)", type: "Psychic" },
  ...
  { name: "Pichu (Spiky-eared)", type: "Electric" },
  ...
  { name: "Heracross (Mega)", type: "Bug/Fighting" },
  ...
  { name: "Houndoom (Mega)", type: "Dark/Fire" },
  { name: "Kingdra", type: "Water/Dragon" },
  ...
  { name: "Tyranitar (Mega)", type: "Rock/Dark" },
  ...
  { name: "Gardevoir (Mega)", type: "Psychic/Fairy" },
  ...
  { name: "Abomasnow (Mega)", type: "Grass/Ice" },
  ...
  { name: "Gallade (Mega)", type: "Psychic/Fighting" },
  ...
  { name: "Samurott (Hisui)", type: "Water/Fighting" },
  ...
  { name: "Darumaka (Galar)", type: "Ice" },
  { name: "Darmanitan", type: "Fire" },
  { name: "Darmanitan (Galar)", type: "Ice/Psychic" },
  ...
  { name: "Yamask (Galar)", type: "Ground/Ghost" },
  ...
  { name: "Stunfisk (Galar)", type: "Ground/Steel" },
  ...
  { name: "Infernape", type: "Fire/Fighting" }, // Actually Gen 4 but included earlier, no forms differ in type here
  { name: "Incineror", type: "Fire" }, // Correction: No such Pokémon — disregard.
  { name: "Torracat", type: "Fire" }, // Already listed
  { name: "Infernape", type: "Fire/Fighting" }, // Duplicate from Gen 4; removing.
  ...
  { name: "Oricorio (Pa'u)", type: "Psychic/Flying" },
  ...
  { name: "Lycanroc (Dusk)", type: "Rock" },
  { name: "Wishiwashi (Solo)", type: "Water" },
  { name: "Wishiwashi (School)", type: "Water" },
  ...
  { name: "Oinkologne (Female)", type: "Normal" },
